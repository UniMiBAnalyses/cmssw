...
# with command line options: step3 --conditions auto:phase2_realistic_T15 -s RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO -n 10 --geometry Extended2026D60 --era Phase2C10,phase2_ecal_devel --eventcontent FEVTDEBUGHLT,MINIAODSIM,DQM --filein file:step2.root --fileout file:step3.root
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_analyzer.root'),
...
process.EcalDigiDumperPh2_step = cms.EndPath(process.EcalDigiDumperPh2)
...
#process.MINIAODSIMoutput_step,process.DQMoutput_step
